...
class EditorLayoutSider extends Component {
  render() {
    const { collapsed, location, openKeys, onOpenChange, toggle } = this.props;
    return (
      <Sider
...
export default EditorLayoutSider;
